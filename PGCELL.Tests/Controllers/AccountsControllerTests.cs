...
namespace PGCELL.Tests.Controllers
{
    ...
    public class AccountsControllerTests
    {
        ...
        public async Task CreateUser_ShouldReturnNoContent_WhenUserIsCreatedSuccessfully()
        {
            ...
            _mockUserHelper.Setup(x => x.AddUserAsync(It.IsAny<User>(), userDTO.Password))
                .ReturnsAsync(IdentityResult.Success);
            _mockUserHelper.Setup(x => x.AddUserToRoleAsync(It.IsAny<User>(), It.IsAny<string>()))
                .Returns(Task.CompletedTask);
            _mockUserHelper.Setup(x => x.GenerateEmailConfirmationTokenAsync(It.IsAny<User>()))
                .ReturnsAsync("token");

            var response = new Response<string> { WasSuccess = true };
            ...
            _mockUserHelper.Verify(x => x.AddUserAsync(It.IsAny<User>(), userDTO.Password), Times.Once());
            _mockUserHelper.Verify(x => x.AddUserToRoleAsync(It.IsAny<User>(), It.IsAny<string>()), Times.Once());
            _mockUserHelper.Verify(x => x.GenerateEmailConfirmationTokenAsync(It.IsAny<User>()), Times.Once());
        ...
        public async Task CreateUser_ShouldReturnBadRequest_WhenEmailNotSent()
        {
            ...
            var response = new Response<string> { WasSuccess = false };
            _mockMailHelper.Setup(x => x.SendMail(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(response);
        ...
        public async Task ConfirmEmailAsync_InvalidToken_ReturnsBadRequest()
        {
            ...
            _mockUserHelper.Setup(x => x.GetUserAsync(It.IsAny<Guid>()))
                .ReturnsAsync(user);
            _mockUserHelper.Setup(x => x.ConfirmEmailAsync(user, token.Replace(" ", "+")))
                .ReturnsAsync(IdentityResult.Failed(identityErrors.ToArray()));
            ...
            Assert.IsNotNull(badRequestResult);
            _mockUserHelper.Verify(x => x.GetUserAsync(It.IsAny<Guid>()), Times.Once());
            _mockUserHelper.Verify(x => x.ConfirmEmailAsync(user, token.Replace(" ", "+")), Times.Once());
        }
        ...
        public async Task Login_LockedOut_ReturnsBadRequest()
        {
            ...
            _mockUserHelper.Setup(x => x.LoginAsync(loginDto))
        ...
        public async Task RecoverPassword_EmailFailedWithMessage_ReturnsBadRequestWithMessage()
        {
            ...
            var response = new Response<string> { WasSuccess = false, Message = message };
            _mockMailHelper.Setup(x => x.SendMail(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(response);
