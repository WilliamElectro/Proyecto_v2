...
namespace PGCELL.Backend.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckWorkersAsync()
        {
            ...
            {
                _context.Workers.Add(new Worker { Document = "1075 11", FirstName = "Sergio", LastName = "Duran", Email = "sergioaduran93@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 1", FirstName = "William" , LastName = "Bohorquez", Email = "a@gmail.com"});
                _context.Workers.Add(new Worker { Document = "1075 2", FirstName = "Sergio", LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 3", FirstName = "Jenny" , LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 4", FirstName = "Karen" , LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 5", FirstName = "Lucas" , LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 6", FirstName = "Luis", LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 7", FirstName = "Martha", LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 8", FirstName = "Miguel", LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 9", FirstName = "Patricia", LastName = "A", Email = "a@gmail.com" });
                _context.Workers.Add(new Worker { Document = "1075 10", FirstName = "Carmen", LastName = "A", Email = "a@gmail.com" });
