...
namespace PGCELL.Backend.Migrations
{
    ...
    [Migration("20231122234308_AddAtributeWorkSheduleToWorker")]
    partial class AddAtributeWorkSheduleToWorker
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PGCELL.Shared.Entites.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PGCELL.Shared.Entites.Modality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PGCELL.Shared.Entites.Worker", b =>
                {
                    ...
                    b.HasOne("PGCELL.Shared.Entites.WorkSchedule", "WorkSchedule")
                        .WithMany()
